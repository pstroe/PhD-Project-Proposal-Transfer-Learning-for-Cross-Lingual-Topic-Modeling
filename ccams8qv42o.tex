...
This calls for elaborate information retrieval (IR) systems which assist scientist in conducting their research. Of course, the functionalities of such systems depend on the data to be analysed
