...
\begin{enumerate}
    ...
    \item Topic modeling algorithms require a predefined number of topics to be inferred. The number of topics can very from newspaper collection to newspaper collection
\end{enumerate}
