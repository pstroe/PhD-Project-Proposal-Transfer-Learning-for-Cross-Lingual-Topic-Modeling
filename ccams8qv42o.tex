...
One technique that has gained popularity over the recent years  topic modeling to infer topics in an unsupervised way are common practices in order to structure textual data. However, there are certain shortcomings when working with digitised text data:
