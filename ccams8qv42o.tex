...
\citet{EisensteinAX11} present an alternative to topic modeling using Dirichlets. They highlight several shortcomings of LDA. For one, it is possible to not only have topics as latent variables, but also sentiment, syntax, or other variables of interet
