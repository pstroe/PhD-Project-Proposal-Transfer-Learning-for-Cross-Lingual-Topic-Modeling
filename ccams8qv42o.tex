...
In the meantime, digitisation has produced huge data silos which are just ``there''. This has the positive effect that scientist nowadays  Often, the systems to analyse and explore the data are missing
