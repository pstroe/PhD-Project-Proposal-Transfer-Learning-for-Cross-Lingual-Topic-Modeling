...
\paragraph{Co-Supervisors: Prof.~Dr.~Barbara Plank, Prof.~Dr.~Albert Weichselbraun, and PD Dr.~Gerold sc}
...
\begin{itemize}
    \item Review research outputs
    \item Provide regular feedback
\end{itemize}

\paragraph{Co-Supervisor: PD Dr.~Gerold Schneider}
