...
Topic modeling is a well researched field. The most often used techniques are Latent Semantic Analysis (LSA) deerwesterscottindexing1990, Probabilistic Latent Semantic Indexing hofmannprobabilistic1999, and Latent Dirichlet Allocation (LDA) bleidynamic2006}. In principle, LSA and LDA represent probabilistic methods to identify possible topics in a text. They take into account the distribution of words in a text and try to narrow down the topic to words which represent the contents of a text best.
