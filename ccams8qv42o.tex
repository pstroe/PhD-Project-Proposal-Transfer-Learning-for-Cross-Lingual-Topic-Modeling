...
One technique that has gained popularity over the recent years and is used in order to categorise textual data is topic modeling. T However, there are certain shortcomings when working with digitised text data:
