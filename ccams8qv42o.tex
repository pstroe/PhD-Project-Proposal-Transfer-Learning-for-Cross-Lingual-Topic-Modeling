...
However, the mere digitisation of newspaper archives does not suffice. The digitised texts must be carefully processed in order to make the information they contain available to researchers. A very basic step is, for example, the structuring of the data into topics. Newspapers hol a myriad of information and they deal with a vast amount of topics. The aim of topic modeling is thus to try to determine which topics are present in a specific text. To know what texts are about is vital, especially if one deals with large text collections.
