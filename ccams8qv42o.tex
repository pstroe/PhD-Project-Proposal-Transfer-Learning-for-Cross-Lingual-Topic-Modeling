...
The similarities of the topic models when applied to newspaper texts suggest a transfer learning approach, which would try to map topics from one newspaper to another. 
