...
\paragraph{OCR errors} This belongs to the preprocessing step of the data and I see clean data as a prerequisite for good topic models. Current research conducted a for a 
