...
Since the words which describe a topic are expected to be semantically related, techniques like LDA profit from the advent of word embeddings mikolovdistributed2013,bengioneural2003, which capture the semantic similarity of words in a low-dimensional vector space. \citeA{dasgaussian2015} successfully incorporate word embeddings into Gaussian LDA and report that their technique outperforms standard LDA especially when dealing with out-of-vocabulary words.
