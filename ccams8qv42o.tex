...
In the meantime, digitisation has produced huge data silos which are just ``there''. At best, the digitised content is avail This has the positive effect that scientist nowadays can access their data online. Often, however, the systems to analyse and explore the data are missing
