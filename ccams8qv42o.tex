...
\paragraph{Topic modeling} The main work of this dissertation will be concerned with topic modeling. I expect a similar topic distribution across different newspapers, mainly for the following two reasons, whicho this end, I establish three working hypothesis:

\begin{enumerate}
    \item , mainly for two reasons: firstly, coarse grained categories like ``Sports'' or ``Economics'' will be present in all newspapers. The topic distribution within those categories could vary, depending on the region and/or country. Secondly, since newspapers follow the same time line, they are likely to report the same events. Again, there might be regional or country-specific differences. 
\end{enumerate}
