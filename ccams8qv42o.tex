...
This calls for more elaborate information retrieval (IR) systems which assist scientists in conducting their research. Of course, the functionalities of such systems depend on the data to be analysed. Currently, the most often digitised data are textual data. Libraries and archives play a key role here. In a way, they act as gatekeepers and their digitisation strategy influences which information is made publicly available or otherwise accessible online. Over the past centuries, libraries and aThey have collected extensive volumes of historical documents over the past centuries. The majority of these collections are stored in shelves, doomed to fall into oblivion. Researchers in the humanities have shown an increasing interest in these data, which is the reason why more and more of these collections are nowadays digitised. 
