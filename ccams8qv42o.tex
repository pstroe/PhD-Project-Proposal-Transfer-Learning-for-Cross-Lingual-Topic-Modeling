...
\begin{enumerate}
    ...
    \item Topic modeling algorithms require a predefined number of topics to be inferred from the text. The number of topics can vary from one newspaper collection to newspaper collection, and hi
\end{enumerate}
