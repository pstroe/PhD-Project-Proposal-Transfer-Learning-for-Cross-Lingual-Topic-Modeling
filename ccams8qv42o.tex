...
One technique that has gained popularity over the recent years and is used in order to d textual data is topic modeling.  However, there are certain shortcomings when working with digitised text data:
