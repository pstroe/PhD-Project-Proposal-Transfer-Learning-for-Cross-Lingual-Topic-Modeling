...
\citet{EisensteinAX11} present an alternative to topic modeling using Dirichlets. They highlight several shortcomings of LDA. For one, it is possible not only 
