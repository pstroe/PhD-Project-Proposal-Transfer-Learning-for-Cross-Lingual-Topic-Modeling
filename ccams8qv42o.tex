...
Literature review & \cellcolor{blue} & \multicolumn{2}{l}{\cellcolor{blue}} & \cellcolor{SkyBlue} & \cellcolor{SkyBlue} & \cellcolor{SkyBlue} & \multicolumn{2}{l}{\cellcolor[HTML]{ECF4FF}} & \cellcolor[HTML]{ECF4FF} & \cellcolor[HTML]{ECF4FF} & \cellcolor[HTML]{ECF4FF} & \multicolumn{2}{l}{\cellcolor[HTML]{ECF4FF}} & \cellcolor[HTML]{ECF4FF} &  \\
