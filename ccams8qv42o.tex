...
\citet{EisensteinAX11} present an alternative to topic modeling using Dirichlets. They highlight three shortcomings of LDA: inference cost, overparametrisation, and lack of sparsity. The key idea is to use Sparse Additive Generative (SAGE) models, where the Dirichlet distribution is replaced by 
