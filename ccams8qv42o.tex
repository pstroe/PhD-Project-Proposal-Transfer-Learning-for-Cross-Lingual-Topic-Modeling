...
In the meantime, digitisation has produced huge data silos which are just ``there''. At best, the digitised content is available over a web interface and can thus be browsed. This has the positive effect that scientist nowadays can access their data online. Often, however, dedicated systems to analyse and explore the data are missing. Current systems provided by libraries and archives merely support  
