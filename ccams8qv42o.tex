...
\begin{enumerate}
    \item Coarse grained categories like ``Sports'' or ``Economics'' will be present in all newspapers. The topic distribution within those categories could vary, depending on the region and/or country. Secondly, since newspapers follow the same time line, they are likely to report the same events. Again, there might be regional or country-specific differences. 
\end{enumerate}
