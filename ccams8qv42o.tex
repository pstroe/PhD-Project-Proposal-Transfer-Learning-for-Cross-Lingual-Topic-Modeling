...
\paragraph{OCR errors} This belongs to the preprocessing step of the data and I see clean data as a prerequisite for good topic models. Current research conducted at our institute show that Handwritten Text Recognition model which can be trained within the Transkribus\footnote{https://transkribus.eu/Transkribus/} framework for a 
