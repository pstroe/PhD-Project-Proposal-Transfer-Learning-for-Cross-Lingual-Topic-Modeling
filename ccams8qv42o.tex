...
\paragraph{Topic modeling - working } The main work of this dissertation will be concerned with topic modeling. I expect a similar topic distribution across different newspapers, mainly for the following two reasons, which serve as working hypotheses:
...
\paragraph{Topic modeling - working package 1}The similarities of the topic models when applied to newspaper texts suggest a transfer learning approach, which would try to map topics from one newspaper to another. Labeled data can help here to produce models
