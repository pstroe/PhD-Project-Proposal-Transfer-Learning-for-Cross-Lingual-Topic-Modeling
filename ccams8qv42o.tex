...
\begin{enumerate}
    ...
    \item Topic models are not able to capture the emergence of new topics and the vanishing of existing topics over time, although dynamic topic modeling tries to model topic 
\end{enumerate}
