...
\begin{enumerate}
    ...
    \item Not all digitised newspapers organise their data in the same way. While newspaper archives like LeTemps Archives\footnote{https://www.letempsarchives.ch/} come in an article segmented form, the Neue Zür
\end{enumerate}
...
\paragraph{Topic modeling - working package 1} The similarities of the topic models when applied to newspaper texts suggest a transfer learning approach, which would try to map topics from one newspaper to another. Labeled data, meaning newspaper pa can help here to produce models
