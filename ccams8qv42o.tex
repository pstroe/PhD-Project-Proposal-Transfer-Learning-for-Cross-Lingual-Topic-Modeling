...
\begin{enumerate}
    \item I expect a similar topic distribution across different newspapers, mainly for two reasons: firstly, coarse grained categories like ``Sports'' or ``Economics'' will be present in all newspapers. The topic distribution within those categories could vary, depending on the region and/or country. Secondly, since newspapers follow the same time line, they are likely to report  
\end{enumerate}
